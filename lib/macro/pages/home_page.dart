...
import 'package:appoint/macro/pages/results_page.dart';
...
import 'package:appoint/macro/data/calculator.dart';
import 'package:appoint/macro/widgets/my_button.dart';
import 'package:appoint/macro/widgets/my_drop_down_button.dart';
import 'package:appoint/macro/widgets/slider.dart';
        ...
        actions: [
          IconButton(
            ...
            icon: Icon(
              ...
              color: isThemeDark(context) ? MyColors.white : MyColors.white,
            ),
            onPressed: () =>
