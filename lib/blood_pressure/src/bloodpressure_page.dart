    ...
    Widget resultWidget() {
      ...
      return StreamedWidget<BloodPressure>(
        ...
        noDataChild: Padding(
            ...
            child: Text(
                '*Huyết áp tâm thu (huyết áp tối đa) là áp lực của máu lên động mạch khi tim co bóp.\n*Huyết áp tâm trương(huyết áp tối thiểu) là áp lực máu lên thành động mạch khi tim giãn ra.\n*Huyết áp tâm thu thường có giá trị cao hơn huyết áp tâm trương.',
                style: TextStyle(
              ...
              children: <Widget>[
                ...
                FadeTransition(
                  ...
                  child: _buildResultRow(
                      'Tâm thu:', snapshot.data.systolic.toStringAsFixed(0)),
                ),
                FadeTransition(
                  opacity: classificationAnimation,
                  child: _buildResultRow('Tâm trương:',
                      snapshot.data.diastolic.toStringAsFixed(0)),
                ),
                SlideTransition(
                  position: pulseAnimation,
                  child: _buildResultRow(
                      'Huyết áp kẹt:', snapshot.data.pulse.toStringAsFixed(0)),
                ),
                SlideTransition(
                  position: meanAnimation,
                  child: _buildResultRow('Huyết áp trung bình:',
                      snapshot.data.map.toStringAsFixed(2)),
                ),
              ],
            ),
          );
          ...
          return Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                labelText: 'Tâm thu',
                hintText: 'Nhập chỉ số huyết áp tâm thu',
          ...
          return Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                hintText: 'Nhập chỉ số huyết áp tâm trương',
                errorText: snapshot.error,
              ),
              keyboardType: TextInputType.number,
