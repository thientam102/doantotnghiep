                      ...
                      Container(
                        decoration: BoxDecoration(
                          ...
                          image: const DecorationImage(
                            image: AssetImage('assets/khtn.jpg'),
                            fit: BoxFit.fill,
                          ),
                          border: Border.all(
                            color: Colors.blue,
    ...
    return StreamBuilder(
      ...
      builder: (context, snapshot) {
        ...
        return Container(
          ...
          child: Text(
            userData['number'] == null ? "Chưa nhập số" : userData['number'],
            style: GoogleFonts.lato(
              fontSize: 20,
              fontWeight: FontWeight.w700,
              color: Colors.black54,
    ...
    return StreamBuilder(
      ...
      builder: (context, snapshot) {
        ...
        return Container(
          ...
          child: Text(
            userData['name'] == null ? "Chưa nhập số" : userData['name'],
            style: GoogleFonts.lato(
              fontSize: 25,
              fontWeight: FontWeight.w700,
              color: Colors.black87,
    ...
    return StreamBuilder(
      ...
      builder: (context, snapshot) {
        ...
        return Container(
          ...
          child: Text(
            userData['phone'] == null ? "Chưa nhập số" : userData['phone'],
            style: GoogleFonts.lato(
              fontSize: 16,
              fontWeight: FontWeight.w700,
              color: Colors.black87,
